...
def bouncing(obj1, objects):
    ...
    if ((-screen.window_height()/2 >= (obj1[0].ycor() - 20)) | ((obj1[0].ycor() + 20) >= screen.window_height()/2)): #top/bottom of screen
        if((-screen.window_height()/2 >= obj1[0].ycor()) | (obj1[0].ycor() >= screen.window_height()/2)):#out of bounds completley
        ...
        #sleep(2)
    if ((-screen.window_width()/2 >= (obj1[0].xcor() - 20)) | ((obj1[0].xcor() + 20) >= screen.window_width()/2)):#sides of screen
        if((-screen.window_width()/2 >= obj1[0].xcor()) | (obj1[0].xcor() >= screen.window_width()/2)):#out of bounds completley
...
def collide(obj1, obj2):
    ...
    if (abs(obj1[0].xcor() - obj2[0].xcor()) > 5):
        #switch x velocityies of objects
        vph = obj1[1][0]
        #print(vph)
        obj1[1][0] = obj2[1][0]
        obj2[1][0] = vph
